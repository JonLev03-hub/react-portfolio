      ...
      extra: [
        {
          title: "My Responsibilities :",
          content:
            "I am designing and building this project is being designed and built by myself. I will be responsible for all front end design, and implimentation.",
        },
        {
          title: "Problems :",
          content:
            "Durring this project I had struggled a lot with design and the use of color. I had been new to web development and design since this project was done when I was studying to be a data scientist. This website also has some issues reguarding best practice for html and has accessibility conserns. I likely won't revisit this project to fix these issues but I believe that it is still a good part of the learning process I endured.",
        },
      ],
    },
  ];
